...
namespace ProiectTetris2
{
    public partial class ScoruriTop : Form
    {
        ...
        private void ScoruriTop_Load(object sender, EventArgs e)
        {
            ...
            string jsonString = System.IO.File.ReadAllText("C:/Users/Dell/Source/Repos/ProiectTetris4/Resources/Scoruri.txt");
            ...
            System.IO.File.WriteAllText("C:/Users/Dell/Source/Repos/ProiectTetris4/Resources/Scoruri.txt", JsonSerializer.Serialize(scoruri));
